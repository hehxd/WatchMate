        ...
        <div className="text-white p-10 flex justify-center items-center h-screen">
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl flex flex-col items-center">
                ...
                <button onClick={() => setView('dashboard')}
                        className="mt-6 px-6 py-2 bg-red-600 hover:bg-red-500 rounded-xl font-bold transition-colors">
                    Go Back
                </button>
            </div>
        </div>
                        ...
                        <div className="flex flex-wrap gap-4 items-start">
                            <button
                                ...
                                className={`px-8 py-4 font-bold rounded-2xl border transition-all flex items-center gap-3 shadow-lg ${
                                    isWatched
                                        ? 'bg-[#0a0a0a]/50 text-gray-600 border-white/5 cursor-not-allowed opacity-50'
                                        : isToWatch
                                            ? 'bg-gradient-to-r from-red-600 to-red-500 text-white border-red-500 shadow-red-500/20'
                                            : 'bg-white/5 text-gray-400 border-white/10 hover:border-white/30 hover:text-white'
                                }`}
                            >
                                <span className="text-xl">📌</span> {isToWatch ? 'In Watchlist' : 'To Watch Next'}
                            </button>
