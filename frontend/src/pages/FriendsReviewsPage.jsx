...
export default function FriendsReviewsPage({ setView, setSelectedMovieId, movies = [], currentUser }) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {filteredReviewedMovies.length > 0 ? (
                        ...
                        <div className="col-span-full text-center py-16 bg-gradient-to-b from-white/5 to-transparent border border-dashed border-white/10 rounded-[2.5rem]">
                            ...
                            <p className="text-sm text-gray-500">Wait for your friends to review some titles, or adjust your filter!</p>
                        </div>
                    )}
                </div>
            </main>
